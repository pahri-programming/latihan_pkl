                                                    ...
                                                    <div class="position-relative">
                                                        <a href="./main/app-chat.html"
                                                            ...
                                                            <div
                                                                ...
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-chat.svg') }}"
                                                        ...
                                                        <a href="./main/app-invoice.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-invoice.svg') }}"
                                                                    alt="modernize-img" class="img-fluid" width="24"
                                                                    height="24" />
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="./main/app-contact2.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-mobile.svg') }}"
                                                                    alt="modernize-img" class="img-fluid" width="24"
                                                                    height="24" />
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="./main/app-email.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-message-box.svg') }}"
                                                                    alt="modernize-img" class="img-fluid" width="24"
                                                                    height="24" />
                                                            </div>
                                                            <div>
                                                ...
                                                <div class="col-6">
                                                    <div class="position-relative">
                                                        <a href="./main/page-user-profile.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-cart.svg') }}"
                                                                    alt="modernize-img" class="img-fluid" width="24"
                                                                    height="24" />
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="./main/app-calendar.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-date.svg') }}"
                                                                    alt="modernize-img" class="img-fluid" width="24"
                                                                    height="24" />
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="./main/app-contact.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-lifebuoy.svg') }}"
                                                                    alt="modernize-img" class="img-fluid" width="24"
                                                                    height="24" />
                                                            </div>
                                                            <div>
                                                        ...
                                                        <a href="./main/app-notes.html"
                                                            ...
                                                            <div
                                                                class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                <img src="{{ asset('assets/backend/images/svgs/icon-dd-application.svg') }}"
